...
<!--                           <tr>
                            <td class="hidden-xs"><a href="#"><?php echo "2017/10/10~12ぶどう収穫募集"; ?></a></td>
                            <td><h5 class="product-title font-alt"><?php echo "2017/10/10~12"; ?></h5></td>
                            <td class="hidden-xs"><input type=button value="削除"></td>
                            <td><h5 class="product-title font-alt">受け入れ完了</h5></td>
                            <td class="pr-remove"><input type="button" value="評価"></td>
                          </tr>
                          <tr>
                            <td class="hidden-xs"><a href="#">2017/10/10~12ぶどう収穫募集！</a></td>
                            <td><h5 class="product-title font-alt">2017/10/10~12</h5></td>
                            <td class="hidden-xs"><input type=button value="削除"></td>
                            <td><h5 class="product-title font-alt"></h5></td>
                            <td class="pr-remove"></td>
                          </tr> -->
                        </tbody>
                      </table>
                    </div>
